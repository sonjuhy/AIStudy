...
class MobileNetV4ConvLargeBackbone(nn.Module):
    ...
    def __init__(self, num_classes: int = 80):
        ...
        # MobileNetV4ConvLarge의 model은 Sequential 구조이므로 필요한 단계만 슬라이싱
        self.stage1 = base_model.model[:2]  # stride 2, 4까지 downsampling
        self.stage2 = base_model.model[2:3]  # stride 8 → P3
        self.stage3 = base_model.model[3:5]  # stride 16 → P4
        self.stage4 = base_model.model[5:16]  # stride 32 → P5 나머지 블록들
